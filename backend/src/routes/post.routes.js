...
import { createPost, deletePost, getAllPosts, getPostById, createPostWithUrl } from '../controllers/post.controller.js';
...
router.post('/create-post-with-url', verifyJWT, createPostWithUrl);
